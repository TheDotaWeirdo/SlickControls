...
namespace MechanikaDesign.WinForms.UI.ColorPicker
{
	...
	internal partial class ColorBox2D : UserControl
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			Pen white = new Pen(Color.White, 1.5F);
			...
			e.Graphics.DrawLine(white, markerPoint.X - 5, this.markerPoint.Y, markerPoint.X - 2, markerPoint.Y);
			e.Graphics.DrawLine(white, markerPoint.X + 2, this.markerPoint.Y, markerPoint.X + 5, markerPoint.Y);
			e.Graphics.DrawLine(white, markerPoint.X, this.markerPoint.Y - 5, markerPoint.X, markerPoint.Y - 2);
			e.Graphics.DrawLine(white, markerPoint.X, this.markerPoint.Y + 2, markerPoint.X, markerPoint.Y + 5);
		}
